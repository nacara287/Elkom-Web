namespace And.ElkomMuhasebe.Core.Model.Entity.FirmaDB
{
 ...
 public int? deleted { get; set; }
        ...
        public string EFATSERINO { get; set; }
          public string EARSIVSERINO { get; set; }
        public string EIRSSERINO { get; set; }

        public string EFATKULLANICIADI { get; set; }

        public string FirmaResimUrl{ get; set; }
    
        public string EFATSÝFRE { get; set; }
        ...
        public bool? DemoPortal { get; set; }
        ...
        public string XSLKODUFATURA { get; set; }
        public string XSLKODUEARSIV{ get; set; }
        public string XSLKODUIRSALIYE { get; set; }
        public string XSLKODUMAKBUZ { get; set; }
        public entegratorler? ENTAGRATOR { get; set; }
        
        public enum entegratorler
        {
            EDM,HizliBilisim
        }
    }
